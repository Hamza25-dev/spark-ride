...
const BookingForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const bookingRes = await fetch("https://car-detailling-dashboard.vercel.app/api/booking", {
        method: "POST",
        headers: {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-charcoal-bg via-dark-bg-1 to-dark-bg-2">
      <div className="flex items-center justify-center p-4 min-h-screen">
        <div className="backdrop-blur-lg border border-primary/20 shadow-2xl rounded-3xl w-full max-w-6xl mx-auto overflow-hidden">
          <div className="bg-gradient-to-r from-dark-bg-1 to-dark-bg-2 p-8">
            <div className="text-center mb-12">
              <h1 className="text-6xl font-bold bg-gradient-to-r from-primary to-text-color bg-clip-text text-transparent mb-4 animate-fade-in">
                Book Your Service
              </h1>
              <p className="text-muted-foreground text-lg">Professional detailing services at your doorstep</p>
            </div>
            ...
            <div className="flex justify-center mb-16">
              {[1, 2, 3].map((n) => (
                <div key={n} className="flex items-center">
                  <div
                    className={`w-16 h-16 flex items-center justify-center rounded-full border-2 text-xl font-bold transition-all duration-500 transform ${
                      currentStep >= n
                        ? 'shadow-2xl scale-110 animate-pulse'
                        : 'border-muted-foreground/50 hover:border-primary/50'
                    }`}
                    style={{
                      backgroundColor: currentStep >= n ? 'var(--primary)' : 'var(--dark-bg-2)',
                      borderColor: currentStep >= n ? 'var(--primary)' : 'var(--muted-foreground)',
                      color: currentStep >= n ? 'var(--charcoal-bg)' : 'var(--muted-foreground)',
                      boxShadow: currentStep >= n ? '0 0 20px rgba(255, 215, 0, 0.3)' : 'none'
                    }}
                  >
                    {n}
                  </div>
                  {n < 3 && (
                    <div
                      className={`w-20 h-1 mx-6 rounded-full transition-all duration-500 ${
                        currentStep > n ? 'animate-pulse' : 'opacity-30'
                      }`}
                      style={{ backgroundColor: currentStep > n ? 'var(--primary)' : 'var(--muted-foreground)' }}
                    ></div>
                  )}
                </div>
              ))}
            ...
            <div className="text-center mb-10">
              <h2 className="text-4xl font-semibold mb-2 animate-fade-in" style={{ color: 'var(--text-color)' }}>
                Step {currentStep}:{" "}
              ...
              <div className="space-y-8 animate-fade-in">
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <select
                            ...
                            className="w-full px-3 py-2 border border-white/30 rounded-md bg-transparent text-white focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500"
                          >
                        ...
                        {serviceType?.variants && (
                          <div>
                            ...
                            <select
                              ...
                              onChange={(e) =>
                                handleVariantChange(vehicle.id, e.target.value)
                              }
                              className="w-full px-3 py-2 border border-white/30 rounded-md bg-transparent text-white focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500"
                            >
                          ...
                          <div className="space-y-4">
                                ...
                                return (
                                  <div
                                    ...
                                    className={`border rounded-lg p-4 cursor-pointer transition-all backdrop-blur-sm ${
                                      isSelected
                                        ? "border-yellow-500 bg-white/5 shadow-lg"
                                        : "border-white/30 bg-white/5 hover:border-yellow-400 hover:shadow-md"
                                    }`}
                                  >
                                    ...
                                    {isSelected && (
                                      <div className="mt-2 text-yellow-400 flex items-center text-sm">
                            ...
                            {additionalServicesList.length > 0 && (
                              <div className="space-y-4 pt-6 border-t border-white/20">
                                <label className="block text-lg font-medium text-yellow-400">
                                  Add-on Services
                                </label>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                  {additionalServicesList.map((svc) => (
                                    ...
                                    >
                                      <input
                                        ...
                                        className="mt-1 h-5 w-5 accent-yellow-500 bg-transparent"
                                      />
                ...
                <div className="flex justify-between pt-4 gap-4">
                  <Button
                    ...
                    className="hover:bg-yellow-700 bg-yellow-600 text-primary-foreground"
                  >
                  ...
                  <Button
                    type="button"
                    onClick={nextStep}
                    className="bg-yellow-500 hover:bg-yellow-600 text-gray-900 px-8 py-2 rounded-lg font-semibold"
              ...
              <div className="space-y-6 animate-fade-in">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="bg-white/10 border border-white/20 rounded-lg p-4 mb-4">
                        <h5 className="font-semibold text-lg mb-3 text-yellow-400">
                          ...
                          {[
                            ...
                            <div key={field.id}>
                              ...
                              <input
                                ...
                                className="w-full px-3 py-2 border border-white/30 rounded-md bg-transparent text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500"
                                required
                              />
                            </div>
                          ))}
                ...
                <div className="flex justify-between pt-4">
                  ...
                  <Button
                    type="button"
                    onClick={nextStep}
                    className="bg-yellow-600 hover:bg-yellow-700 text-white px-8 py-2 rounded-lg font-semibold"
                        ...
                        <button
                          ...
                          className={cn(
                            ...
                            formData.timeSlot === time
                              ...
                              : "bg-white/10 text-white border-white/30 hover:border-yellow-500 hover:bg-white/20"
                          )}
                ...
                <div className="border border-white/20 rounded-lg p-4 bg-white/5 backdrop-blur-sm">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 px-3 py-2 border border-white/30 rounded-md bg-transparent text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500"
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                            ...
                            <div className="md:col-span-2 text-right font-medium text-yellow-400">
              ...
              <div className="bg-green-900/30 border border-green-500/30 rounded-lg p-4 text-center">
                ...
                {appliedPromo && (
                  <p className="text-green-400">
                    Promo applied: {appliedPromo.code} ({appliedPromo.discount}%
                    off)
                  </p>
                )}
              </div>
